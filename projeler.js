/* YENİ PROJE EKLEMEK İÇİN:
   Aşağıdaki süslü parantez { ... }, bloğunu kopyala,
   bir virgül koyup altına yapıştır ve içindeki yazıları değiştir.
*/

const tumProjeler = [
    {
        baslik: "Güzelyalı Villa Projesi",
        ...
        aciklama: "Modern mimari ile tasarlanmış, 140m² dubleks hafif çelik yapı."
    },
    {
        baslik: "Ezine Bağ Evi",
        kategori: "Prefabrik",
        resim: "https://images.unsplash.com/photo-1516455590571-18256e5bb9ff?auto=format&fit=crop&w=800&q=80",
        konum: "Ezine, Çanakkale",
        aciklama: "Doğayla iç içe, 2+1 planında 80m² ekonomik prefabrik ev çözümü."
    },
    {
        baslik: "Biga Şantiye Ofisi",
        kategori: "Konteyner",
        resim: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=800&q=80",
        konum: "Biga, Çanakkale",
        aciklama: "Birleşimli konteyner sistemiyle oluşturulan ofis kompleksi."
    },
